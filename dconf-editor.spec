...
Source0  : https://download.gnome.org/sources/dconf-editor/3.38/dconf-editor-3.38.2.tar.xz
...
%prep
%setup -q -n dconf-editor-3.38.2
cd %{_builddir}/dconf-editor-3.38.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606161702
...
cp %{_builddir}/dconf-editor-3.38.2/COPYING %{buildroot}/usr/share/package-licenses/dconf-editor/31a3d460bb3c7d98845187c716a30db81c44b615
