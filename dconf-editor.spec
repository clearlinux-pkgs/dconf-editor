...
Version  : 3.36.0
Release  : 11
URL      : https://download.gnome.org/sources/dconf-editor/3.36/dconf-editor-3.36.0.tar.xz
Source0  : https://download.gnome.org/sources/dconf-editor/3.36/dconf-editor-3.36.0.tar.xz
...
%prep
%setup -q -n dconf-editor-3.36.0
cd %{_builddir}/dconf-editor-3.36.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585614061
...
cp %{_builddir}/dconf-editor-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/dconf-editor/31a3d460bb3c7d98845187c716a30db81c44b615
