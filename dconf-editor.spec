...
Source0  : https://download.gnome.org/sources/dconf-editor/3.34/dconf-editor-3.34.3.tar.xz
...
%prep
%setup -q -n dconf-editor-3.34.3
cd %{_builddir}/dconf-editor-3.34.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578355959
...
cp %{_builddir}/dconf-editor-3.34.3/COPYING %{buildroot}/usr/share/package-licenses/dconf-editor/31a3d460bb3c7d98845187c716a30db81c44b615
